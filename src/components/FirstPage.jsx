        ...
        <div className="flex gap-6 flex-wrap items-center justify-center max-w-9xl w-full px-6 py-6">
          ...
          <div className="relative w-72">
            ...
            <input
              ...
              className="bg-white w-full py-4 pr-4 pl-10 border border-gray-300 rounded-lg text-base "
            />
          </div>

          {/* Category */}
          <div className="w-50">
            <select className="w-full py-4 px-6 border border-gray-300 rounded-lg bg-white ">
